...
import com.chetan.offlinechat.domain.chat.ConnectionResult
...
class AndroidBluetoothController(
            ...
            currentClientSocket?.let { socket ->
                try {
                    ...
                    BluetoothDataTransferService(socket).also {
                        ...
                        emitAll(
                            it.listenForIncomingMessage().map { ConnectionResult.TransferSucceeded(it ) }
                        )
                    }
                } catch (e: IOException) {
                    socket.close()
    ...
    companion object {
        const val SERVICE_UUID = "b9c05fa4-9d9e-48c7-a4b6-65e6a0af65a6"
    }
}